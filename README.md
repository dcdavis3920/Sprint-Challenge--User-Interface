...
Semantic html is the basic structure of your page. It describes to the browser the layout and meaning of your page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
inline are on the same line and block starts a new line.
...
It allows you to make random saves of your code and store it in Github.
